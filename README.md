...
[![Build Status](https://travis-ci.org/iatec-docs/PeopleManagementApi.svg?branch=master)](https://travis-ci.org/iatec-docs/PeopleManagementApi)
...
6. If you did everything correct, https://iatec-docs.github.io/PeopleManagementApi/ will lead to your new docs
...
- Documentation(ReDoc): https://iatec-docs.github.io/PeopleManagementApi/
- SwaggerUI: https://iatec-docs.github.io/PeopleManagementApi/swagger-ui/
- Look full spec:
    + JSON https://iatec-docs.github.io/PeopleManagementApi/swagger.json
    + YAML https://iatec-docs.github.io/PeopleManagementApi/swagger.yaml
- Preview spec version for branch `[branch]`: https://iatec-docs.github.io/PeopleManagementApi/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://iatec-docs.github.io/PeopleManagementApi/ with url from the message: `Server started <url>`
